<nav class="navbar navbar-expand-lg bg-body-tertiary pt-3">
  <div class="container-fluid">
    ...
    <form class="d-flex" >
        ...
        <button type="button" class="btn btn-outline-success mx-2"> <span class="glyphicon glyphicon-shopping-cart"> </span> <i class="bi bi-cart"></i><b> Shopping Cart </b>  
        </button>  
        <!-- <a class="btn btn-outline-danger mx-2" type="submit" href="logout.php">Logout</a> <i class="bi bi-cart"></i> -->
    </form>
